...
user1 = User.create!( name: 'Tom', photo: image, bio:'Programer', posts_counter: 0, email: 'tom@example.com', password: 'tom123',role: 'admin' )
...
user4 = User.create!( name: 'David', photo: image, bio: 'Painter', posts_counter: 0, email: 'david@example.com', password: 'david123',role:'admin')
user5 = User.create!( name: 'Admin', photo: image, bio: 'Admin', posts_counter: 0, email: 'admin@example.com', password: 'admin123',role:'admin')
